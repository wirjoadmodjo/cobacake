						...
						<div class="box-body">
							...
							<div class="direct-chat-contacts">
								<ul class="contacts-list">
									<li><a href="#"> 
									<?=$this->Html->image ( 'AdminLTE.user1-128x128.jpg', [ 'class' => 'contacts-list-img','alt' => 'User Image' ] );?>
									...
									<!-- End Contact Item -->
									<li><a href="#"> 
									<?=$this->Html->image ( 'AdminLTE.user7-128x128.jpg', [ 'class' => 'contacts-list-img','alt' => 'User Image' ] );?>
									...
									<!-- End Contact Item -->
									<li><a href="#"> 
										<?=$this->Html->image ( 'AdminLTE.user3-128x128.jpg', [ 'class' => 'contacts-list-img','alt' => 'User Image' ] );?>
									...
									<!-- End Contact Item -->
									<li><a href="#"> 
										<?=$this->Html->image ( 'AdminLTE.user5-128x128.jpg', [ 'class' => 'contacts-list-img','alt' => 'User Image' ] );?>
									...
									<!-- End Contact Item -->
									<li><a href="#"> <?=$this->Html->image ( 'AdminLTE.user6-128x128.jpg', [ 'class' => 'contacts-list-img','alt' => 'User Image' ] );?>
									...
									<!-- End Contact Item -->
									<li><a href="#"> <?=$this->Html->image ( 'AdminLTE.user8-128x128.jpg', [ 'class' => 'contacts-list-img','alt' => 'User Image' ] );?>
						...
						<div class="box-body no-padding">
							<ul class="users-list clearfix">
								<li>
									...
									class="users-list-date">Today</span>
								</li>
								<li>
									<?= $this->Html->image ( 'AdminLTE.user8-128x128.jpg', [ 'alt' => 'User Image' ] );?>
									<a class="users-list-name" href="#">Norman</a> <span
									class="users-list-date">Yesterday</span>
								</li>
								<li><?= $this->Html->image ( 'AdminLTE.user7-128x128.jpg', [ 'alt' => 'User Image' ] );?> <a
									class="users-list-name" href="#">Jane</a> <span
									class="users-list-date">12 Jan</span></li>
								<li><?= $this->Html->image ( 'AdminLTE.user6-128x128.jpg', [ 'alt' => 'User Image' ] );?> <a
									class="users-list-name" href="#">John</a> <span
									class="users-list-date">12 Jan</span></li>
								<li><?= $this->Html->image ( 'AdminLTE.user2-160x160.jpg', [ 'alt' => 'User Image' ] );?> <a
									class="users-list-name" href="#">Alexander</a> <span
									class="users-list-date">13 Jan</span></li>
								<li><?= $this->Html->image ( 'AdminLTE.user5-128x128.jpg', [ 'alt' => 'User Image' ] );?> <a
									class="users-list-name" href="#">Sarah</a> <span
									class="users-list-date">14 Jan</span></li>
								<li><?= $this->Html->image ( 'AdminLTE.user4-128x128.jpg', [ 'alt' => 'User Image' ] );?> <a
									class="users-list-name" href="#">Nora</a> <span
									class="users-list-date">15 Jan</span></li>
								<li><?= $this->Html->image ( 'AdminLTE.user3-128x128.jpg', [ 'alt' => 'User Image' ] );?> <a
									class="users-list-name" href="#">Nadia</a> <span
									class="users-list-date">15 Jan</span></li>
							</ul>
							<!-- /.users-list -->
						</div>
				...
				<div class="box-footer no-padding">
					<ul class="nav nav-pills nav-stacked">
						<li><a href="#">United States of America <span
								class="pull-right text-red"><i class="fa fa-angle-down"></i> 12%</span></a></li>
					...
					<ul class="products-list product-list-in-box">
						<li class="item">
							<div class="product-img">
								...
								<?= $this->Html->image ( 'AdminLTE.default-50x50.gif', [ 'alt' => 'Product Image' ] );?>
							</div>
							<div class="product-info">
								<a href="javascript:void(0)" class="product-title">Samsung TV <span
									class="label label-warning pull-right">$1800</span>
						...
						<li class="item">
							...
							<div class="product-info">
								<a href="javascript:void(0)" class="product-title">Xbox One <span
									...
									class="product-description"> Xbox One Console Bundle with Halo
									Master Chief Collection. </span>
							</div>
						</li>
						<!-- /.item -->
						<li class="item">
...
$this->Html->script ( [ 
		'AdminLTE./lib/sparkline/jquery.sparkline.min',
		'AdminLTE./lib/jvectormap/jquery-jvectormap-1.2.2.min',
		'AdminLTE./lib/jvectormap/jquery-jvectormap-world-mill-en',
		'AdminLTE./lib/chartjs/Chart.min',
