...
<section class="content-header">
	<?= $this->element('breadcrumb', ['_breadcrumb' => $breadcrumb]); ?>
</section>
		...
		<section class="col-lg-7 connectedSortable">
			...
			<div class="box box-success">
				...
				<div class="box-body chat" id="chat-box">
					<!-- chat item -->
					<div class="item">
						<?=$this->Html->image ( 'AdminLTE.user4-128x128.jpg', [ 'class' => 'online','alt' => 'User Image' ] );?>
									<p class="message">
					...
					<!-- chat item -->
					<div class="item">
									<?=$this->Html->image ( 'AdminLTE.user3-128x128.jpg', [ 'class' => 'offline','alt' => 'User Image' ] );?>
									<p class="message">
							<a href="#" class="name"> <small class="text-muted pull-right"><i
					...
					<!-- chat item -->
					<div class="item">
									<?=$this->Html->image ( 'AdminLTE.user2-160x160.jpg', [ 'class' => 'offline','alt' => 'User Image' ] );?>
									<p class="message">
							<a href="#" class="name"> <small class="text-muted pull-right"><i
